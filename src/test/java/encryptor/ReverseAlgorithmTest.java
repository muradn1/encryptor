...
public class ReverseAlgorithmTest {
    ...
    public void testDoubleAlgorithmEncryptionAndDecryption() throws Exception{
        ...
        reverseAlgorithm.<CaesarAlgorithm,CaesarAlgorithm>encrypt(key,fileForEncrypt,caesarAlgorithm,null);

        fileForDecrypt = new MyFile(pathOfFileForDecrypt);

        reverseAlgorithm.<CaesarAlgorithm,XorAlgorithm>decrypt(key,fileForDecrypt,caesarAlgorithm,null);
